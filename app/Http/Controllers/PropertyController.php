...
class PropertyController extends Controller
{
     ...
     */
    public function create(): RedirectResponse|Response|Redirector|Application
    {
        ...
        if (Auth::check()) {
            ...
            return Redirect::to('/login')
                ->with('message', 'You must be logged in and a landlord/agent to create a property');
        }
    }
    ...
    public function show(Property $property)
    {
        return Inertia::render('Property/Show', [
            'property' => $property
                ->load('landlord.user', 'currentTenant.user', 'media'),
        ]);
    }
