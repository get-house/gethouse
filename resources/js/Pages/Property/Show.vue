        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 pt-6">
            <div class="md:col-span-3 mx-6">
                ...
                <h2 class="text-gray-800 text-xl font-semibold my-4">
                    ...
                    Quis velit unde incidunt hic id. Ipsa, quod.
                </h2>
                ...
                <div class="my-4">
                    ...
                    <p class="text-slate-800">
                        ...
                        elit. Alias, adipisci. Veniam atque totam molestias ab
                        culpa quisquam voluptates id ex dolorum consequatur,
                        facilis non molestiae iusto laboriosam! Sed, asperiores.
                        Officia.
                    </p>
                </div>
                <div class="my-4">
